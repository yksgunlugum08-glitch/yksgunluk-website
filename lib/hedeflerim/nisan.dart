...
class NisanWeeklyPlanPage extends StatefulWidget {
  const NisanWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _NisanWeeklyPlanPageState createState() => _NisanWeeklyPlanPageState();
}

class _NisanWeeklyPlanPageState extends State<NisanWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Nisan Haftalık Planlama'),
