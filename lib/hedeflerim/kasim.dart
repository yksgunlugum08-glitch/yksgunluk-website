...
class KasimWeeklyPlanPage extends StatefulWidget {
  const KasimWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _KasimWeeklyPlanPageState createState() => _KasimWeeklyPlanPageState();
}

class _KasimWeeklyPlanPageState extends State<KasimWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Kasım Haftalık Planlama'),
