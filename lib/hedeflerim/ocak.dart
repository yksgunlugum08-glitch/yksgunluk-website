...
class OcakWeeklyPlanPage extends StatefulWidget {
  const OcakWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _OcakWeeklyPlanPageState createState() => _OcakWeeklyPlanPageState();
}

class _OcakWeeklyPlanPageState extends State<OcakWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Ocak Haftalık Planlama'),
