...
class EylulWeeklyPlanPage extends StatefulWidget {
  const EylulWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _EylulWeeklyPlanPageState createState() => _EylulWeeklyPlanPageState();
}

class _EylulWeeklyPlanPageState extends State<EylulWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Eylül Haftalık Planlama'),
