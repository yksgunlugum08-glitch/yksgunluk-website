...
class SubatWeeklyPlanPage extends StatefulWidget {
  const SubatWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _SubatWeeklyPlanPageState createState() => _SubatWeeklyPlanPageState();
}

class _SubatWeeklyPlanPageState extends State<SubatWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Şubat Haftalık Planlama'),
