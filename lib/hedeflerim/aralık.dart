...
class AralikWeeklyPlanPage extends StatefulWidget {
  const AralikWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _AralikWeeklyPlanPageState createState() => _AralikWeeklyPlanPageState();
}

class _AralikWeeklyPlanPageState extends State<AralikWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Aralık Haftalık Planlama'),
