...
class EkimWeeklyPlanPage extends StatefulWidget {
  const EkimWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _EkimWeeklyPlanPageState createState() => _EkimWeeklyPlanPageState();
}

class _EkimWeeklyPlanPageState extends State<EkimWeeklyPlanPage> {
  ...
  void _removeTopic(String topic) async {
    setState(() {
      // Tüm haftalardaki "Bitireceğim Konular" listesinden sil
      ...
      // Tüm haftalardaki "Tekrar Edeceğim Konular" listesinden sil
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Ekim Haftalık Planlama'),
