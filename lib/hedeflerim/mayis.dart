...
class MayisWeeklyPlanPage extends StatefulWidget {
  const MayisWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _MayisWeeklyPlanPageState createState() => _MayisWeeklyPlanPageState();
}

class _MayisWeeklyPlanPageState extends State<MayisWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Mayıs Haftalık Planlama'),
