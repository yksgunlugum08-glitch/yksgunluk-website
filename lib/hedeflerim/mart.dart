...
class MartWeeklyPlanPage extends StatefulWidget {
  const MartWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _MartWeeklyPlanPageState createState() => _MartWeeklyPlanPageState();
}

class _MartWeeklyPlanPageState extends State<MartWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Mart Haftalık Planlama'),
