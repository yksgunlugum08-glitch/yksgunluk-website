...
class TemmuzWeeklyPlanPage extends StatefulWidget {
  const TemmuzWeeklyPlanPage({Key? key}) : super(key: key);

  @override
  _TemmuzWeeklyPlanPageState createState() => _TemmuzWeeklyPlanPageState();
}

class _TemmuzWeeklyPlanPageState extends State<TemmuzWeeklyPlanPage> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('Temmuz Haftalık Planlama'),
